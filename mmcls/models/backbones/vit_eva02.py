...
class ViTEVA02(VisionTransformer):
    ...
    def __init__(self,
        ...
        # self.ln1_name, ln1 = build_norm_layer(
        #     norm_cfg, self.embed_dims)
        # self.add_module(self.ln1_name, ln1)


    # @property
    # def ln1(self):
    #     return getattr(self, self.ln1_name)
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.layers):
            ...
            if i in self.out_indices:
                ...
                if i == self.out_indices[-1] and self.avg_token:
